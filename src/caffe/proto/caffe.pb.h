...
class HingeRankLossParameter;
class HungarianLossParameter;
...
enum V1LayerParameter_LayerType {
  ...
  V1LayerParameter_LayerType_HINGE_RANK_LOSS = 47,
...
const V1LayerParameter_LayerType V1LayerParameter_LayerType_LayerType_MAX = V1LayerParameter_LayerType_HINGE_RANK_LOSS;
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.HingeRankLossParameter hinge_rank_loss_param = 144;
  inline bool has_hinge_rank_loss_param() const;
  inline void clear_hinge_rank_loss_param();
  static const int kHingeRankLossParamFieldNumber = 144;
  inline const ::caffe::HingeRankLossParameter& hinge_rank_loss_param() const;
  inline ::caffe::HingeRankLossParameter* mutable_hinge_rank_loss_param();
  inline ::caffe::HingeRankLossParameter* release_hinge_rank_loss_param();
  inline void set_allocated_hinge_rank_loss_param(::caffe::HingeRankLossParameter* hinge_rank_loss_param);

  // optional .caffe.HungarianLossParameter hungarian_loss_param = 145;
  inline bool has_hungarian_loss_param() const;
  inline void clear_hungarian_loss_param();
  static const int kHungarianLossParamFieldNumber = 145;
  inline const ::caffe::HungarianLossParameter& hungarian_loss_param() const;
  inline ::caffe::HungarianLossParameter* mutable_hungarian_loss_param();
  inline ::caffe::HungarianLossParameter* release_hungarian_loss_param();
  inline void set_allocated_hungarian_loss_param(::caffe::HungarianLossParameter* hungarian_loss_param);
 ...
 private:
  ...
  inline void set_has_hinge_rank_loss_param();
  inline void clear_has_hinge_rank_loss_param();
  inline void set_has_hungarian_loss_param();
  inline void clear_has_hungarian_loss_param();
  ...
  ::caffe::HingeRankLossParameter* hinge_rank_loss_param_;
  ::caffe::HungarianLossParameter* hungarian_loss_param_;
...
class TransformationParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional float gaussian_noise_std = 8 [default = 1];
  inline bool has_gaussian_noise_std() const;
  inline void clear_gaussian_noise_std();
  static const int kGaussianNoiseStdFieldNumber = 8;
  inline float gaussian_noise_std() const;
  inline void set_gaussian_noise_std(float value);

  // optional float uniform_noise_range = 9 [default = 1];
  inline bool has_uniform_noise_range() const;
  inline void clear_uniform_noise_range();
  static const int kUniformNoiseRangeFieldNumber = 9;
  inline float uniform_noise_range() const;
  inline void set_uniform_noise_range(float value);

  // optional float noise_mask_ratio = 10 [default = 1];
  inline bool has_noise_mask_ratio() const;
  inline void clear_noise_mask_ratio();
  static const int kNoiseMaskRatioFieldNumber = 10;
  inline float noise_mask_ratio() const;
  inline void set_noise_mask_ratio(float value);
 ...
 private:
  ...
  inline void set_has_gaussian_noise_std();
  inline void clear_has_gaussian_noise_std();
  inline void set_has_uniform_noise_range();
  inline void clear_has_uniform_noise_range();
  inline void set_has_noise_mask_ratio();
  inline void clear_has_noise_mask_ratio();
  ...
  bool force_color_;
  bool force_gray_;
  float gaussian_noise_std_;
  float uniform_noise_range_;
  float noise_mask_ratio_;
...
class HingeRankLossParameter : public ::google::protobuf::Message {
 public:
  HingeRankLossParameter();
  virtual ~HingeRankLossParameter();

  HingeRankLossParameter(const HingeRankLossParameter& from);

  inline HingeRankLossParameter& operator=(const HingeRankLossParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const HingeRankLossParameter& default_instance();

  void Swap(HingeRankLossParameter* other);

  // implements Message ----------------------------------------------

  HingeRankLossParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const HingeRankLossParameter& from);
  void MergeFrom(const HingeRankLossParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // @@protoc_insertion_point(class_scope:caffe.HingeRankLossParameter)
 private:
  inline void set_has_margin();
  inline void clear_has_margin();
  ...
  void InitAsDefaultInstance();
  static HingeRankLossParameter* default_instance_;
};
// -------------------------------------------------------------------

class HungarianLossParameter : public ::google::protobuf::Message {
 public:
  HungarianLossParameter();
  virtual ~HungarianLossParameter();

  HungarianLossParameter(const HungarianLossParameter& from);

  inline HungarianLossParameter& operator=(const HungarianLossParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const HungarianLossParameter& default_instance();

  void Swap(HungarianLossParameter* other);

  // implements Message ----------------------------------------------

  HungarianLossParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const HungarianLossParameter& from);
  void MergeFrom(const HungarianLossParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  inline bool has_match_ratio() const;
  inline void clear_match_ratio();
  static const int kMatchRatioFieldNumber = 1;
  inline float match_ratio() const;
  inline void set_match_ratio(float value);

  // optional bool permute_matches = 2 [default = true];
  inline bool has_permute_matches() const;
  inline void clear_permute_matches();
  static const int kPermuteMatchesFieldNumber = 2;
  inline bool permute_matches() const;
  inline void set_permute_matches(bool value);

  // @@protoc_insertion_point(class_scope:caffe.HungarianLossParameter)
 private:
  inline void set_has_match_ratio();
  inline void clear_has_match_ratio();
  inline void set_has_permute_matches();
  inline void clear_has_permute_matches();

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  float match_ratio_;
  bool permute_matches_;
  ...
  void InitAsDefaultInstance();
  static HungarianLossParameter* default_instance_;
};
// -------------------------------------------------------------------
...
class V1LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  static const LayerType HINGE_RANK_LOSS = V1LayerParameter_LayerType_HINGE_RANK_LOSS;
  ...
  // optional .caffe.HingeRankLossParameter hinge_rank_loss_param = 49;
  inline bool has_hinge_rank_loss_param() const;
  inline void clear_hinge_rank_loss_param();
  static const int kHingeRankLossParamFieldNumber = 49;
  inline const ::caffe::HingeRankLossParameter& hinge_rank_loss_param() const;
  inline ::caffe::HingeRankLossParameter* mutable_hinge_rank_loss_param();
  inline ::caffe::HingeRankLossParameter* release_hinge_rank_loss_param();
  inline void set_allocated_hinge_rank_loss_param(::caffe::HingeRankLossParameter* hinge_rank_loss_param);
...
// optional .caffe.HingeRankLossParameter hinge_rank_loss_param = 144;
inline bool LayerParameter::has_hinge_rank_loss_param() const {
  return (_has_bits_[0] & 0x10000000u) != 0;
}
inline void LayerParameter::set_has_hinge_rank_loss_param() {
  _has_bits_[0] |= 0x10000000u;
}
inline void LayerParameter::clear_has_hinge_rank_loss_param() {
  _has_bits_[0] &= ~0x10000000u;
}
inline void LayerParameter::clear_hinge_rank_loss_param() {
  if (hinge_rank_loss_param_ != NULL) hinge_rank_loss_param_->::caffe::HingeRankLossParameter::Clear();
  clear_has_hinge_rank_loss_param();
}
inline const ::caffe::HingeRankLossParameter& LayerParameter::hinge_rank_loss_param() const {
  return hinge_rank_loss_param_ != NULL ? *hinge_rank_loss_param_ : *default_instance_->hinge_rank_loss_param_;
}
inline ::caffe::HingeRankLossParameter* LayerParameter::mutable_hinge_rank_loss_param() {
  set_has_hinge_rank_loss_param();
  if (hinge_rank_loss_param_ == NULL) hinge_rank_loss_param_ = new ::caffe::HingeRankLossParameter;
  return hinge_rank_loss_param_;
}
inline ::caffe::HingeRankLossParameter* LayerParameter::release_hinge_rank_loss_param() {
  clear_has_hinge_rank_loss_param();
  ::caffe::HingeRankLossParameter* temp = hinge_rank_loss_param_;
  hinge_rank_loss_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_hinge_rank_loss_param(::caffe::HingeRankLossParameter* hinge_rank_loss_param) {
  delete hinge_rank_loss_param_;
  hinge_rank_loss_param_ = hinge_rank_loss_param;
  if (hinge_rank_loss_param) {
    set_has_hinge_rank_loss_param();
  } else {
    clear_has_hinge_rank_loss_param();
  }
...
// optional .caffe.HungarianLossParameter hungarian_loss_param = 145;
inline bool LayerParameter::has_hungarian_loss_param() const {
  return (_has_bits_[0] & 0x20000000u) != 0;
}
inline void LayerParameter::set_has_hungarian_loss_param() {
  _has_bits_[0] |= 0x20000000u;
}
inline void LayerParameter::clear_has_hungarian_loss_param() {
  _has_bits_[0] &= ~0x20000000u;
}
inline void LayerParameter::clear_hungarian_loss_param() {
  if (hungarian_loss_param_ != NULL) hungarian_loss_param_->::caffe::HungarianLossParameter::Clear();
  clear_has_hungarian_loss_param();
}
inline const ::caffe::HungarianLossParameter& LayerParameter::hungarian_loss_param() const {
  return hungarian_loss_param_ != NULL ? *hungarian_loss_param_ : *default_instance_->hungarian_loss_param_;
}
inline ::caffe::HungarianLossParameter* LayerParameter::mutable_hungarian_loss_param() {
  set_has_hungarian_loss_param();
  if (hungarian_loss_param_ == NULL) hungarian_loss_param_ = new ::caffe::HungarianLossParameter;
  return hungarian_loss_param_;
}
inline ::caffe::HungarianLossParameter* LayerParameter::release_hungarian_loss_param() {
  clear_has_hungarian_loss_param();
  ::caffe::HungarianLossParameter* temp = hungarian_loss_param_;
  hungarian_loss_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_hungarian_loss_param(::caffe::HungarianLossParameter* hungarian_loss_param) {
  delete hungarian_loss_param_;
  hungarian_loss_param_ = hungarian_loss_param;
  if (hungarian_loss_param) {
    set_has_hungarian_loss_param();
  } else {
    clear_has_hungarian_loss_param();
  }
...
// optional float gaussian_noise_std = 8 [default = 1];
inline bool TransformationParameter::has_gaussian_noise_std() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void TransformationParameter::set_has_gaussian_noise_std() {
  _has_bits_[0] |= 0x00000080u;
}
inline void TransformationParameter::clear_has_gaussian_noise_std() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void TransformationParameter::clear_gaussian_noise_std() {
  gaussian_noise_std_ = 1;
  clear_has_gaussian_noise_std();
}
inline float TransformationParameter::gaussian_noise_std() const {
  return gaussian_noise_std_;
}
inline void TransformationParameter::set_gaussian_noise_std(float value) {
  set_has_gaussian_noise_std();
  gaussian_noise_std_ = value;
}

// optional float uniform_noise_range = 9 [default = 1];
inline bool TransformationParameter::has_uniform_noise_range() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void TransformationParameter::set_has_uniform_noise_range() {
  _has_bits_[0] |= 0x00000100u;
}
inline void TransformationParameter::clear_has_uniform_noise_range() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void TransformationParameter::clear_uniform_noise_range() {
  uniform_noise_range_ = 1;
  clear_has_uniform_noise_range();
}
inline float TransformationParameter::uniform_noise_range() const {
  return uniform_noise_range_;
}
inline void TransformationParameter::set_uniform_noise_range(float value) {
  set_has_uniform_noise_range();
  uniform_noise_range_ = value;
}

// optional float noise_mask_ratio = 10 [default = 1];
inline bool TransformationParameter::has_noise_mask_ratio() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void TransformationParameter::set_has_noise_mask_ratio() {
  _has_bits_[0] |= 0x00000200u;
}
inline void TransformationParameter::clear_has_noise_mask_ratio() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void TransformationParameter::clear_noise_mask_ratio() {
  noise_mask_ratio_ = 1;
  clear_has_noise_mask_ratio();
}
inline float TransformationParameter::noise_mask_ratio() const {
  return noise_mask_ratio_;
}
inline void TransformationParameter::set_noise_mask_ratio(float value) {
  set_has_noise_mask_ratio();
  noise_mask_ratio_ = value;
}
...
// optional float margin = 1 [default = 1];
inline bool HingeRankLossParameter::has_margin() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void HingeRankLossParameter::set_has_margin() {
  _has_bits_[0] |= 0x00000001u;
}
inline void HingeRankLossParameter::clear_has_margin() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void HingeRankLossParameter::clear_margin() {
  margin_ = 1;
  clear_has_margin();
}
inline float HingeRankLossParameter::margin() const {
  return margin_;
}
inline void HingeRankLossParameter::set_margin(float value) {
  set_has_margin();
  margin_ = value;
}
...
// optional float match_ratio = 1 [default = 0.5];
inline bool HungarianLossParameter::has_match_ratio() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void HungarianLossParameter::set_has_match_ratio() {
  _has_bits_[0] |= 0x00000001u;
}
inline void HungarianLossParameter::clear_has_match_ratio() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void HungarianLossParameter::clear_match_ratio() {
  match_ratio_ = 0.5f;
  clear_has_match_ratio();
}
inline float HungarianLossParameter::match_ratio() const {
  return match_ratio_;
}
inline void HungarianLossParameter::set_match_ratio(float value) {
  set_has_match_ratio();
  match_ratio_ = value;
}

// optional bool permute_matches = 2 [default = true];
inline bool HungarianLossParameter::has_permute_matches() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void HungarianLossParameter::set_has_permute_matches() {
  _has_bits_[0] |= 0x00000002u;
}
inline void HungarianLossParameter::clear_has_permute_matches() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void HungarianLossParameter::clear_permute_matches() {
  permute_matches_ = true;
  clear_has_permute_matches();
}
inline bool HungarianLossParameter::permute_matches() const {
  return permute_matches_;
}
inline void HungarianLossParameter::set_permute_matches(bool value) {
  set_has_permute_matches();
  permute_matches_ = value;
}
...
// optional .caffe.HingeRankLossParameter hinge_rank_loss_param = 49;
inline bool V1LayerParameter::has_hinge_rank_loss_param() const {
  return (_has_bits_[0] & 0x02000000u) != 0;
}
inline void V1LayerParameter::set_has_hinge_rank_loss_param() {
  _has_bits_[0] |= 0x02000000u;
}
inline void V1LayerParameter::clear_has_hinge_rank_loss_param() {
  _has_bits_[0] &= ~0x02000000u;
}
inline void V1LayerParameter::clear_hinge_rank_loss_param() {
  if (hinge_rank_loss_param_ != NULL) hinge_rank_loss_param_->::caffe::HingeRankLossParameter::Clear();
  clear_has_hinge_rank_loss_param();
}
inline const ::caffe::HingeRankLossParameter& V1LayerParameter::hinge_rank_loss_param() const {
  return hinge_rank_loss_param_ != NULL ? *hinge_rank_loss_param_ : *default_instance_->hinge_rank_loss_param_;
}
inline ::caffe::HingeRankLossParameter* V1LayerParameter::mutable_hinge_rank_loss_param() {
  set_has_hinge_rank_loss_param();
  if (hinge_rank_loss_param_ == NULL) hinge_rank_loss_param_ = new ::caffe::HingeRankLossParameter;
  return hinge_rank_loss_param_;
}
inline ::caffe::HingeRankLossParameter* V1LayerParameter::release_hinge_rank_loss_param() {
  clear_has_hinge_rank_loss_param();
  ::caffe::HingeRankLossParameter* temp = hinge_rank_loss_param_;
  hinge_rank_loss_param_ = NULL;
  return temp;
}
inline void V1LayerParameter::set_allocated_hinge_rank_loss_param(::caffe::HingeRankLossParameter* hinge_rank_loss_param) {
  delete hinge_rank_loss_param_;
  hinge_rank_loss_param_ = hinge_rank_loss_param;
  if (hinge_rank_loss_param) {
    set_has_hinge_rank_loss_param();
