...
int main(int argc, char** argv)
{
	...
	// prototxt
	Net<float> caffe_test_net("C:/Users/cht2pal/Desktop/caffe-old-unpool/examples/DeconvNet/model/FCN/fcn-8s-pascalcontext-deploy.prototxt", TEST);

	// caffemodel
	caffe_test_net.CopyTrainedLayersFrom("C:/Users/cht2pal/Desktop/caffe-old-unpool/examples/DeconvNet/model/FCN/fcn-8s-pascalcontext.caffemodel");
	...
	for(int i = 0; i < out_blob->height(); i++){
		for(int j=0; j < out_blob->width(); j++){
			...
			for(int c = 0; c < out_blob->channels(); c++){ // for 60 channels
